  ...
  return (
    <svg viewBox="0 0 280 140" {...props}>
      <g fill="none" fillRule="evenodd">
        ...
        <rect fill="#4B5563" x={30} y={58} width={220} height={24} rx={4} />
        <path d="M242 68l-4 4m4 0l-4-4" stroke="#FFF" strokeLinecap="round" />
        <rect fill="#9FA6B2" x={56} y={69} width={104} height={2} rx={1} />
        <path
