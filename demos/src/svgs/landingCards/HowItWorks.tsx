    ...
    <svg viewBox="0 0 280 140" {...props}>
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(66 4)">
          <rect fill="#6B7280" x={10} y={9} width={28} height={2} rx={1} />
          <rect fill="#D2D6DC" y={14} width={56} height={2} rx={1} />
          <rect fill="#D2D6DC" y={19} width={52} height={2} rx={1} />
          <rect fill="#D2D6DC" y={24} width={39} height={2} rx={1} />
          <rect fill="#9FA6B2" y={29} width={7} height={2} rx={1} />
          <path d="M79 5a3 3 0 013-3h62a3 3 0 013 3v31H79V5z" fill="#E5E7EB" />
          <path
            fill="#6B7280"
        ...
        <g transform="matrix(-1 0 0 1 213 50)">
          <rect fill="#6B7280" x={14} y={7} width={28} height={2} rx={1} />
          <rect fill="#D2D6DC" y={12} width={56} height={2} rx={1} />
          <rect fill="#D2D6DC" y={17} width={52} height={2} rx={1} />
          <rect fill="#D2D6DC" y={22} width={39} height={2} rx={1} />
          <rect fill="#9FA6B2" y={27} width={7} height={2} rx={1} />
          <path d="M79 3a3 3 0 013-3h62a3 3 0 013 3v31H79V3z" fill="#E5E7EB" />
          <path
        ...
        <g transform="translate(66 97)">
          <rect fill="#6B7280" x={10} y={7} width={28} height={2} rx={1} />
          <rect fill="#D2D6DC" y={12} width={56} height={2} rx={1} />
          <rect fill="#D2D6DC" y={17} width={52} height={2} rx={1} />
          <rect fill="#D2D6DC" y={22} width={39} height={2} rx={1} />
          <rect fill="#9FA6B2" y={27} width={7} height={2} rx={1} />
